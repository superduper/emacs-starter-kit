...
5. *Typopunct-mode.* Если не вдаваться в подробности профессиональной
...
6. Загружаем /typopunct.el/ и выбираем русскую типографику:
...
7. Функция включает /typopunct-mode/.
...
8. Здесь я включаю типографику в режимах /org-mode/ и
...
9. *Magit-mode.* Режим для работы с системой контроля версий git.
